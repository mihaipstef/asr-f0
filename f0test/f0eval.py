...
trainSpeakers_3nn = [ ("cmu_us_slt_arctic", "female"), ("cmu_us_awb_arctic", "male"), ("H26", "child"), ("H27", "child"),
...
trainSpeakers_2nn = [ ("cmu_us_slt_arctic", "female"), ("cmu_us_awb_arctic", "male") ]

testSpeakers_3nn = [ ("cmu_us_clb_arctic", "female"), ("cmu_us_bdl_arctic", "male"), ("H45", "child"), ("H46", "child"),
...
testSpeakers_2nn = [ ("cmu_us_clb_arctic", "female"), ("cmu_us_bdl_arctic", "male") ]

speakers, testSpeakers, trainFunc = trainSpeakers_3nn, testSpeakers_3nn, train3NNClassifier
